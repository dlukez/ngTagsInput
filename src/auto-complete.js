...
tagsInput.directive('autoComplete', function($document, $timeout, $sce, tagsInputConfig) {
    function SuggestionList(loadFn, options) {
        var self = {}, debouncedLoadId, getDifference, lastPromise, getIdProperty;
        ...
        getDifference = function(array1, array2) {
            return array1.filter(function(item) {
                return !findInObjectArray(array2, item, getIdProperty());
            });
        };
        ...
        self.load = function(query, tags) {
            ...
            debouncedLoadId = $timeout(function() {
                ...
                promise.then(function(items) {
                    ...
                    items = makeObjectArray(items.data || items, getIdProperty());
